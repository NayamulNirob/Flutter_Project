...
class AllProductcategoryUserView extends StatefulWidget {
  ...
  @override
  State<AllProductcategoryUserView> createState() => _AllProductcategoryViewState();
}

class _AllProductcategoryViewState extends State<AllProductcategoryUserView> {
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            SubCategoriesUserPage(category: category),
                      ),
                    );
                  },
                  child: Card(
